/**
 */
package dk.dtu.compute.se.mdsu.petrinet.provider;
...
/**
 * This is the item provider adapter for a {@link dk.dtu.compute.se.mdsu.petrinet.Arc} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArcItemProvider 
	...
	public String getText(Object object) {
		// includes the name of the source and target node to the
		// label of the Arc
		String extension = " ";
		if (object instanceof Arc) {
			Node source = ((Arc) object).getSource();
			if (source != null) {
			...
			Node target = ((Arc) object).getTarget();
			if (target != null) {
		...
		return getTextGen(object) + extension;
	}
